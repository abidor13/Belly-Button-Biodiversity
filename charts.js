...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var otu_ids = metadataresult["otu_ids"];
    var otu_labels = metadataresult["otu_labels"];
    var sample_values = metadataresult["sample_values"];

    // 3. Create a variable that holds the washing frequency.
    wfrequency = metadataresult["wfreq"];
